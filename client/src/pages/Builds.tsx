...
import { formatPrice, getWhatsAppUrl, generateComboWhatsAppMessage, contactConfig } from '../utils/whatsapp';
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-32 sm:pb-28 space-y-12 bg-white">
      ...
      <div className="text-center max-w-2xl mx-auto space-y-3">
        <span className="text-xs font-semibold text-[#0071e3] tracking-wider uppercase">
          Certified Hardware Combos
        </span>
        <h1 className="text-3xl sm:text-5xl font-bold text-[#1d1d1f] tracking-tight">
          Balanced Build Bundles.
        </h1>
